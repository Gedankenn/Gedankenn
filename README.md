<a href="https://git.io/typing-svg">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&duration=2000&pause=100&center=true&vCenter=true&multiline=true&width=720&height=175&lines=GUIs+are+a+lie%2C+they+are+just+front-ends+to+the+shell.;Through+the+shell%2C+I+gain+sudo.;Through+sudo%2C+I+gain+power.;Through+power%2C+I+gain+root.;Through+root%2C+my+chains+are+broken.;uid%3D0+shall+set+me+free...." alt="Typing SVG" />
</a>
...
- 🔬 [**ESP32 Drivers**](https://github.com/Gedankenn/esp32_drivers)  
  Low-level driver development (ADC, PWM, GPIO) with register-level control

- 🌐 [**IPv6 File Transfer System**](https://github.com/Gedankenn/file_transfer_python)  
  Experimental lightweight file transfer protocol over IPv6

- 📈 [**Terminal Stock Portfolio**](https://github.com/Gedankenn/stocks)  
  CLI system with custom data processing and visualization

- 🌡️ [**ESP8266 Sensor Platform**](https://github.com/Gedankenn/arduino_temp_sensor)  
  Embedded data acquisition system with server integration
